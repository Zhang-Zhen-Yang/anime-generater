...
WaveEditor.prototype.mix = function(arrm, modem, filenamem) {
    ...
    if (modem === 'download') {
        //.......................................DOWNLOAD..............................................///
        var blob = new Blob([headerBuf2, bSAMPLES], {
            type: 'audio/wav'
        });
        downloadLink = document.createElement('a');
...
WaveEditor.prototype.mixBuffers = function(arr, modem, filenamem) {
    ...
    if (modem === 'download') {
        //.......................................DOWNLOAD..............................................///
        var blob = new Blob([headerBuf3, SAMPLES1], {
            type: 'audio/wav'
        });
        downloadLink = document.createElement('a');
        downloadLink.download = filenamem;
...
WaveEditor.prototype.cutBuffer = function(buffer, cutFactor, modem, filenamem) {
    ...
    if (modem === 'download') {
        //.......................................DOWNLOAD..............................................///
        var blob = new Blob([headerBuf4, cut], {
            type: 'audio/wav'
        });
        downloadLink = document.createElement('a');
        downloadLink.download = filenamem;
...
function CharCodetoText(code) {
    var str = '';
    this.code = code;
    for (i = 0; i < this.code.length; i++) str += String.fromCharCode(this.code[i]);
    return str;
}
...
function EndianDecToDecimal(EndianEncoding) {
    ...
    var sum = 0;
    for (var i = 0; i < this.e.length; i++) sum |= this.e[i] << (i * 8);
    return sum;
}
